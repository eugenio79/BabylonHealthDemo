...
extension PostListControllerTests {
  ...
  func givenRemoteServiceRespondingWithTwoPosts() -> PostRemoteService {
    ...
    var posts: [Post] = []
    let post1 = RestPost(id: 1, userId: 1, title: "sunt aut facere repellat provident occaecati excepturi optio reprehenderit", body: "quia et suscipit\nsuscipit recusandae consequuntur expedita et cum\nreprehenderit molestiae ut ut quas totam\nnostrum rerum est autem sunt rem eveniet architecto")
    let post2 = RestPost(id: 1, userId: 2, title: "qui est esse", body: "est rerum tempore vitae\nsequi sint nihil reprehenderit dolor beatae ea dolores neque\nfugiat blanditiis voluptate porro vel nihil molestiae ut reiciendis\nqui aperiam non debitis possimus qui neque nisi nulla")
    posts.append(post1)
    posts.append(post2)
